...
const loadWidgetScript = (): Promise<void> => {
    ...
    loadPromise = new Promise((resolve) => {
        ...
        // Inject the script inline instead of loading from external file
